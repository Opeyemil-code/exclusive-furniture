...
export default function Image(params) {
    ...
    return(
        <section className="lg:w-2/3 mx-auto mt-20 bg-blue-40 w-11/12" data-aos="fade-up">
            ...
            <input className="border-2 bg-white lg:px-48 lg:py-4 border-white shadow-md shadow-black lg:ml-60 py-3 px-6 justify-content ml-12 rounded-lg mt-4 z-" type="text"  placeholder="search your product"/>
           </div>
