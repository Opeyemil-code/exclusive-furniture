        ...
        <div className="flex flex-col mt-6">
             ...
             <div className="flex flex-col space-y-5">
                ...
                <div className="lg:flex-row flex-col flex lg:space-x-6 mt-6 space-y-4 lg:space-y-0" >
                  ...
                  <input data-aos="flip-lett" type="text" className="border-2 px-4 py-2 border-darkblue rounded-md" placeholder="Last name"/>
                 </div>
                  ...
                  <div className="flex flex-col space-y-4">
                    ...
                    <input data-aos="flip-up" type="text"  className="border-2 py-14 border-darkblue rounded-lg" placeholder="Message"/>
                  </div>
